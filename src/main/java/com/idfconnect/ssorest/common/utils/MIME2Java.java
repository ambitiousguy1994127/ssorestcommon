...
public class MIME2Java {
     ...
     * @return Java encoding name, or <var>null</var> if <var>mimeCharsetName</var> is unknown. * @see #reverse */
    public static String convert(String mimeCharsetName) {
        return s_enchash.get(mimeCharsetName.toUpperCase());
    }

        /**
         * Convert a Java encoding name to MIME charset name. Available values of <i>encoding</i> are "UTF8", "8859_1", "8859_2", "8859_3", "8859_4", "8859_5",
         * "8859_6", "8859_7", "8859_8", "8859_9", "JIS", "SJIS", "EUCJIS", "GB2312", "BIG5", "KSC5601", "ISO2022KR", "KOI8_R", "CP037", "CP277", "CP278", "CP280",
         * "CP284", "CP285", "CP297", "CP420", "CP424", "CP500", "CP870", "CP871" and "CP918".
         *
